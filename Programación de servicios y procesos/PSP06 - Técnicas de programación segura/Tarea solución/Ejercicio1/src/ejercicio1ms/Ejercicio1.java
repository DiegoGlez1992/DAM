 ...
 * El login tiene una longitud de 8 caracteres y está compuesto únicamente por letras
 * minúsculas.
 * Solicita al usuario el nombre de un fichero que quiere mostrar. 
 * El nombre del fichero es como máximo de 8 caracteres y tiene una extensión de 3
 * caracteres.
...
public class Ejercicio1 {
    ...
    private final String logfich = "ejercicio1.log"; //fichero de log
    static final Logger logger = Logger.getLogger(Ejercicio1.class.getName());  
//    escoger como directorio el de trabajo del usuario 
    String directorio = System.getProperty("user.home", "not specified");
    ...
    private void LeerFichero() {
        ...
        try {
            do {
                ...
                pattern = Pattern.compile("[a-zA-Z0-9]{1,8}.[a-z]{3}");
    ...
    private void IniciarLog(String nombrelog) {
        ...
        try {
            ...
            Logger.getLogger(Ejercicio1.class.getName()).log(Level.SEVERE, null, e);
        }
    }
    ...
    public static void main(String[] args) {
        /**
         * Descomentar las dos lineas si queremos ver como funciona si añadimos
         * seguridad java. En el enunciado no se pedía, lo pongo solo para que
         * podáis verlo, a modo de ejemplo.
         */
//        System.setProperty("java.security.policy", "./ejer1.policy");
