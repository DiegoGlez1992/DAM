...
public class Cliente {
    ...
    public Cliente() {
        try {
            ...
            do {
                System.out.println(dataInputStream.readUTF());  //Recibe solicitud de usuario
                user = bufferedReader.readLine();    //Lee el nombre de usuario del teclado
                dataOutputStream.writeUTF(user); //Envía el nombre de usuario
                System.out.println(dataInputStream.readUTF());  //Recibe solicitud de contraseña
                user = bufferedReader.readLine();    //Lee la contraseña de usuario del teclado
                dataOutputStream.writeUTF(user); //Envía la contraseña de usuario
                System.out.println(dataInputStream.readUTF());  //Recibe respuesta de log in
            } while (dataInputStream.readUTF().equalsIgnoreCase("NACK"));
